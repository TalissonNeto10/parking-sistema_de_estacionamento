<?php
    ...
    public function __construct(){
       ...
       public function index(){
        ...
        $this->form_validation->set_rules('sistema_razao_social', 'Razão social', 'trim|required|min_length[5]|max_length[150]');
        $this->form_validation->set_rules('sistema_nome_fantasia', 'Nome fantasia', 'trim|required|min_length[5]|max_length[150]');
        $this->form_validation->set_rules('sistema_cnpj', 'CNPJ', 'trim|required|exact_length[18]');
        $this->form_validation->set_rules('sistema_ie', 'Inscrição Estadual(IE)', 'trim|required|min_length[5]|max_length[25]');
        ...
        $this->form_validation->set_rules('sistema_cidade', 'cidade', 'trim|required|min_length[4]|max_length[145]');
        ...
        $this->form_validation->set_rules('sistema_texto_ticket', 'Texto do ticket de estacionamento', 'trim|required|max_length[500]');
        if($this->form_validation->run()){
            ...
            $data = array(
                ...
                'sub_titulo' => 'Faça sua edicão conforme a informação da sua empresa',
