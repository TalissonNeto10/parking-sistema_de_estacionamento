    ...
    public function __construct(){
        ...
        public function index(){
            ...
            $data = array(
                ...
                'sub_titulo' => 'Listando dos os mensalistas cadastrados',
           ...
           public function core($mensalista_id = NULL){
                ...
                if(!$mensalista_id){
                    ...
                    $this->form_validation->set_rules('mensalista_nome', 'Nome', 'trim|required|min_length[4]|max_length[30]');
                        $this->form_validation->set_rules('mensalista_sobrenome', 'Sobrenome', 'trim|required|min_length[4]|max_length[130]');
                        ...
                        $this->form_validation->set_rules('mensalista_telefone_movel', 'Telefone móvel', 'trim|min_length[12]|max_length[15]|is_unique[mensalistas.mensalista_telefone_movel]');
                        $this->form_validation->set_rules('mensalista_cep', 'CEP', 'trim|required|exact_length[9]');
                        $this->form_validation->set_rules('mensalista_endereco', 'Endereço', 'trim|required|min_length[4]|max_length[155]');
                        $this->form_validation->set_rules('mensalista_numero_endereco', 'Número', 'trim|required|max_length[20]');
                        $this->form_validation->set_rules('mensalista_bairro', 'Bairro', 'trim|required|min_length[4]|max_length[105]');
                        $this->form_validation->set_rules('mensalista_cidade', 'Cidade', 'trim|required|min_length[4]|max_length[105]');
                        ...
                        $this->form_validation->set_rules('mensalista_dia_vencimento', 'Dia de vencimento do mensalidade', 'trim|integer|greater_than[0]|less_than[32]');
                        $this->form_validation->set_rules('mensalista_obs', 'Observação', 'trim|min_length[4]|max_length[105]');
                        ...
                        if($this->form_validation->run()){
                            ...
                            $data = array(
                                ...
                                'titulo' => 'cadastro de mensalistas',
                                'sub_titulo' => 'cadastre todos os mensalistas',
                                'icone_view' => 'fas fa-users',
                    ...
                    if(!$this->Core_model->get_by_id('mensalistas', array('mensalista_id'=> $mensalista_id))){
                        ...
                        $this->form_validation->set_rules('mensalista_telefone_movel', 'Telefone móvel', 'trim|min_length[12]|max_length[15]|callback_check_telefone_movel');
                        $this->form_validation->set_rules('mensalista_cep', 'CEP', 'trim|required|exact_length[9]');
                        $this->form_validation->set_rules('mensalista_endereco', 'Endereço', 'trim|required|min_length[4]|max_length[155]');
                        $this->form_validation->set_rules('mensalista_numero_endereco', 'Número', 'trim|required|max_length[20]');
                        $this->form_validation->set_rules('mensalista_bairro', 'Bairro', 'trim|required|min_length[4]|max_length[105]');
                        ...
                        if($this->form_validation->run()){
                            ...
                            if($mensalista_ativo == 0){
                                ...
                                if($this->db->table_exists('mensalidades')){
                                    ...
                                    if($this->Core_model->get_by_id('mensalidades', array('mensalidade_mensalista_id' => $mensalista_id, 'mensalidade_status' => 0))){
                                        $this->session->set_flashdata('error', 'O <i class="fas fa-users"></i>Mensalistas com débito pendentes não pode ser desativados');
                                        redirect($this->router->fetch_class());
                                    }
                            ...
                            $data = array(
                                ...
                                'titulo' => 'Editando mensalistas',
                                'sub_titulo' => 'Editando todos mensalistas cadastrados',
                                'icone_view' => 'fas fa-users',
          ...
          public function check_email($mensalista_email){
                ...
                if ($this->Core_model->get_by_id('mensalistas', array('mensalista_id !=' => $mensalista_id, 'mensalista_email' => $mensalista_email))) {
                    $this->form_validation->set_message('mensalista_email', 'O campo {field} já existe, ele deve ser único');
                    return FALSE;
                }else{
                    return TRUE;
                }
