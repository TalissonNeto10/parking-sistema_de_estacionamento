    ...
    public function __construct(){
        ...
        public function index(){
            ...
            $data = array(
                ...
                'sub_titulo' => 'Listando dos as precificações cadastradas',
                'icone_view' => 'far fa-money-bill-alt',
            ...
            if(!$precificacao_id){
                    ...
                    //exit();
                        ...
                        $data = array(
                            ...
                            'sub_titulo' => 'Cadastre sua precificação',
                            'icone_view' => 'fas fa-money-check-alt',
                ...
                $this->session->set_flashdata('error', 'Precificações não encontrada');
                redirect($this->router->fetch_class());
                        ...
                        if($precificacao_ativa == 0){
                            ...
                            if($this->db->table_exists('estacionar')){
                                ...
                                if($this->Core_model->get_by_id('estacionar', array('estacionar_precificacao_id' => $precificacao_id, 'estacionar_status' => 0))){
                                    $this->session->set_flashdata('error', 'Esta categoria está sendo utilizada em <i class="fal fa-car-garage"></i>&nbspEstacionar');
                                    redirect($this->router->fetch_class());
                                }
                        ...
                        if($precificacao_ativa == 0){
                            ...
                            if($this->db->table_exists('mensalidades')){
                                ...
                                if($this->Core_model->get_by_id('mensalidades', array('mensalidade_precificacao_id' => $precificacao_id, 'mensalidade_status' => 0))){
                                    $this->session->set_flashdata('error', 'Esta categoria está sendo utilizada em <i class="fas fa-hand-holding-usd"></i>&nbspMensalidades');
                                    redirect($this->router->fetch_class());
                                }
                    ...
                    //exit();
                        ...
                        $data = array(
                            ...
                            'sub_titulo' => 'Editar as precificações cadastradas',
                            'icone_view' => 'fas fa-money-check-alt',
