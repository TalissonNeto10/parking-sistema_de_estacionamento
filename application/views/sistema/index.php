    ...
    <div class="app-sidebar colored">
        <div class="sidebar-header">
            <a class="header-brand" href="index.html">
                <div class="logo-img">
                <img src="src/img/logo.png" class="header-brand-img" alt="lavalite"> 
                </div>
    ...
    <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><i class="fas fa-calendar-alt"></i>&nbsp;<?php echo(isset($sistema) ? 'Data da Última Alteração: &nbsp;'
                                     .formata_data_banco_com_hora($sistema->sistema_data_alteracao)
                                    : '' ); ?></div>
                                    <div class="card-body">
                                    ...
                                    <form class="forms-sample" name="form_index" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5 mb-24">
                                                    ...
                                                    <textarea type="text" class="form-control" name="sistema_texto_ticket"><?php echo(isset($sistema) ? 
                                                    $sistema->sistema_texto_ticket : set_value('sistema_texto_ticket'));?></textarea>
                                        ...
                                        <a href="<?php echo base_url('/'); ?>"class="btn btn-light"><i class="fas fa-arrow-left"></i>Voltar</a>
                                    </form>
