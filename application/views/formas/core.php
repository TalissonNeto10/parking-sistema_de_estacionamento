    ...
    <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header"><i class="fas fa-calendar-alt"></i>&nbsp;<?php echo(isset($forma) ? 'Data da Última Alteração: &nbsp;' .formata_data_banco_com_hora($forma->forma_pagamento_data_alteracao)
                                            : '' ); ?></div>
                                            <div class="card-body">
                                            ...
                                            <form class="forms-sample" name="form_core" method="POST">
                                             ...
                                             <?php if(isset($forma)): ?>
                                                <div class="form-group row">
                                                    ...
                                                    value="<?php echo $forma->forma_pagamento_id;?>"></input>
