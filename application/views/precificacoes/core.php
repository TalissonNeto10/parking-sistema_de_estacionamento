    ...
    <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header"><i class="fas fa-calendar-alt"></i>&nbsp;<?php echo(isset($precificacao) ? 'Data da Última Alteração: &nbsp;' .formata_data_banco_com_hora($precificacao->precificacao_data_alteracao)
                                            : '' ); ?></div>
                                            <div class="card-body">
