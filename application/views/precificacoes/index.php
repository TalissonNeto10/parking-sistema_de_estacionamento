                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table class=" table data-table">
                                            ...
                                            <?php foreach ($precificacoes as $categoria): ?>
                                                ...
                                                href="<?php echo base_url($this->router->fetch_class().'/core/'.$categoria->precificacao_id); ?>" class="btn btn-icon btn-primary"><i class="ik ik-edit-2"></i></a>
                                                
                                                <button  type="button" class="btn btn-icon btn-danger" data-toggle="modal" 
                                                 data-target="#categoria-<?php echo $categoria->precificacao_id; ?>" ><i class="ik ik-trash-2"></i></button>
                                                </td>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a data-toggle="tooltip" data-placement="top" title="Excluir <?php echo $this->router->fetch_class();?>" 
                                                href="<?php echo base_url($this->router->fetch_class().'/del/'.$categoria->precificacao_id); ?>" class="btn btn-danger">Sim, Excluir</a>
                                    </div>
                                </div>
                            </div>
                        </div>
