            ...
            <div class="main-content">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header"><i class="fas fa-calendar-alt"></i>&nbsp;<?php echo(isset($mensalidade) ? 'Data da Última Alteração: &nbsp;' .formata_data_banco_com_hora($mensalidade->mensalidade_data_alteracao)
                                            : '' ); ?></div>
                                            <div class="card-body">
    ...
    <div class="col-md-4 mb-3">
        ...
        <select class="form-control" name="mensalidade_status" <?php echo (isset($mensalidade) && $mensalidade->mensalidade_status == 1 ? 'disabled' : ''); ?>>
            <?php if (isset($mensalidade)): ?>
                ...
                <option value="0" <?php echo ($mensalidade->mensalidade_status == 0 ? 'selected' : '') ?>>Aberta</option>
