            ...
            <div class="main-content">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header"><i class="fas fa-calendar-alt"></i>&nbsp;<?php echo(isset($mensalista) ? 'Data da Última Alteração: &nbsp;' .formata_data_banco_com_hora($mensalista->mensalista_data_alteracao)
                                            : '' ); ?></div>
                                            <div class="card-body">
                                ...
                                <!----------------------Form de alteração de cadastro------------------------------>
                                            <form class="forms-sample" name="form_core" method="POST">
                                                    ...
                                                    value="<?php echo(isset($mensalista) ? $mensalista->mensalista_data_nascimento : set_value('mensalista_data_nascimento'));?>">
                                                     ...
                                                     <div class="col-md-2 mb-20">
                                                        ...
                                                        <div class="col-md-2 mb-20">
                                                            ...
                                                            <label >RG:</label>
                                                            <input type="text" class="form-control rg" name="mensalista_rg"
                                                ...
                                                <div class="col-md-6 mb-20">
                                                    ...
                                                    <textarea rows="1" type="text" class="form-control" name="mensalista_obs"><?php echo(isset($mensalista) ? 
                                                    $mensalista->mensalista_obs : set_value('sistema_texto_ticket'));?></textarea>
                                             ...
                                             <?php if(isset($mensalista)): ?>
                                                <div class="form-group row">
                                                    ...
                                                    value="<?php echo $mensalista->mensalista_id;?>"></input>
